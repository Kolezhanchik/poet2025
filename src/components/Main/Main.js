    ...
    return (
        <div className="section">
            ...
            <div className="main">
                ...
                <p className="section__text">
                    Перейдите во вкладку "Каталог" и выбирите подходяшую вам категории с гарантией интрепретации, форма откроется по клику на выбранный текст
                </p>
                <h3 className="section__subtitile">
                   Вы хотите выбрать стихотворение сами:
                </h3>
                <p className="section__text">
                    Перейдите во вкладку поиск и выбирите подходяшее вам стихотворение по ключевому слову, форма откроется по клику на выбранный текст
